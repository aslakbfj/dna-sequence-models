...
if [ -f $HOME_DATA/AS-TAC_1000bp_no21_no25.tsv ]; then
  echo "21_25.tsv exists"
    ...
    awk '$1 ~ /^21|^25/' $DATA_FOLDER/AS-TAC_1000bp.tsv > $HOME_DATA/AS-TAC_1000bp_21_25.tsv
    # make a subset of the data that did not contain 21 or 25
    echo "creating subset of AS-TAC_1000bp.tsv"
    awk '$1 !~ /^21|^25/' $DATA_FOLDER/AS-TAC_1000bp.tsv > $HOME_DATA/AS-TAC_1000bp_no21_no25.tsv
fi
